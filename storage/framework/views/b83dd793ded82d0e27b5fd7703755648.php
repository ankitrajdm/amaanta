        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-30">
                    <div class="section-subtitle"><?php echo e($sections['services_section']->meta['subtitle'] ?? 'Our Services'); ?></div>
                    <div class="section-title"><?php echo e($sections['services_section']->heading ?? 'Amaanta'); ?> <span><?php echo e($sections['services_section']->meta['highlight'] ?? 'Services'); ?></span></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                    <div class="img left">
                        <img src="<?php echo e(asset($sections['services_section']->meta['service1_image'] ?? 'assets/img/services/service_list1.jpg')); ?>" alt="">
                    </div>
                </div>
                <div class="col-md-6 valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            <h4><span><?php echo e($sections['services_section']->meta['service1_title'] ?? 'Decoration'); ?></span> | Events </h4>
                            <p><?php echo e($sections['services_section']->meta['service1_content'] ?? ''); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            <h4 class="white"><span><?php echo e($sections['services_section']->meta['service2_title'] ?? 'Luxury suites'); ?></span> | Events</h4>
                            <p><?php echo e($sections['services_section']->meta['service2_content'] ?? ''); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 order1 animate-box" data-animate-effect="fadeInRight">
                    <div class="img">
                        <img src="<?php echo e(asset($sections['services_section']->meta['service2_image'] ?? 'assets/img/services/service-2.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
