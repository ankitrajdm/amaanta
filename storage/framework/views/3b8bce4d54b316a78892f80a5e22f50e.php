...
<div class="row mb-4">
    <div class="col-md-12">
        <h1><?php echo e(isset($page) ? 'Edit Page' : 'Create Page'); ?></h1>
    </div>
</div>

<div class="card">
    <div class="card-body">
        <form action="<?php echo e(isset($page) ? route('admin.pages.update', $page) : route('admin.pages.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php if(isset($page)): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1"
                           <?php echo e(old('is_active', $page->is_active ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> <?php echo e(isset($page) ? 'Update' : 'Create'); ?> Page
                </button>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\amaanta\resources\views\admin\pages\create.blade.php ENDPATH**/ ?>