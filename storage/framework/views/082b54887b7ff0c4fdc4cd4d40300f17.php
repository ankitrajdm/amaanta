...
<?php $__env->startSection('title', 'Add Guest Feedback'); ?>

<?php $__env->startSection('content'); ?>
<div class="row mb-4">
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center">
            <h1>Add Guest Feedback</h1>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>Guest Feedback Form</h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.guest-feedbacks.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="guest_name" name="guest_name" value="<?php echo e(old('guest_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="room_number" name="room_number" value="<?php echo e(old('room_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="check_in_date" name="check_in_date" value="<?php echo e(old('check_in_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="check_out_date" name="check_out_date" value="<?php echo e(old('check_out_date')); ?>" required>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="heard_about_us" id="heard_<?php echo e(str_replace(' ', '_', $option)); ?>" value="<?php echo e($option); ?>" <?php echo e(old('heard_about_us') == $option ? 'checked' : ''); ?> required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="reservation_method" id="reservation_<?php echo e(str_replace(' ', '_', $option)); ?>" value="<?php echo e($option); ?>" <?php echo e(old('reservation_method') == $option ? 'checked' : ''); ?> required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="visit_purpose" id="purpose_<?php echo e($option); ?>" value="<?php echo e($option); ?>" <?php echo e(old('visit_purpose') == $option ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" name="service_quality" required>
                                    ...
                                    <option value="<?php echo e($option); ?>" <?php echo e(old('service_quality') == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="cleanliness" required>
                                    <option value="">Select Rating</option>
                                    <?php $__currentLoopData = $ratingOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option); ?>" <?php echo e(old('cleanliness') == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="staff_rating" required>
                                    <option value="">Select Rating</option>
                                    <?php $__currentLoopData = $ratingOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option); ?>" <?php echo e(old('staff_rating') == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="additional_feedback" rows="4" placeholder="Any additional comments or suggestions..."><?php echo e(old('additional_feedback')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="status" required>
                                    ...
                                    <option value="reviewed" <?php echo e(old('status') == 'reviewed' ? 'selected' : ''); ?>>Reviewed</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="agree_to_submit" value="1" id="agree_to_submit" <?php echo e(old('agree_to_submit') ? 'checked' : ''); ?>>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Save Guest Feedback
                            </button>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\amaanta\resources\views\admin\guest-feedbacks\create.blade.php ENDPATH**/ ?>