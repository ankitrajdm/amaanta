...
<?php $__env->startSection('title', 'Edit Contact Form'); ?>
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('admin.contact-forms.update', $contactForm)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="event_date" name="event_date" value="<?php echo e(old('event_date', $contactForm->event_date ? $contactForm->event_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="responded_at" name="responded_at" value="<?php echo e(old('responded_at', $contactForm->responded_at ? $contactForm->responded_at->format('Y-m-d\TH:i') : '')); ?>">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\amaanta\resources\views\admin\contact-forms\edit.blade.php ENDPATH**/ ?>