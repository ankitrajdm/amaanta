...
<head>
    ...
    <title><?php echo e($settings['website_name'] ?? 'Amaanta Farms'); ?></title>
...
<!-- Navbar -->
                        ...
                        <div class="col-md-5 slider-text js-fullheight">
                            <div class="slider-text-inner">
                                <div class="desc text-start">
                                    <h4><?php echo e($settings['website_name'] ?? 'Amaanta'); ?></h4>
                                    <h1><?php echo $sections['banner']->heading ?? 'Where Nature Meets Elegance'; ?></h1>
                                    <p><?php echo $sections['banner']->content ?? 'A world-class farm in Delhi offering serene <span>natural beauty</span> for unforgettable celebrations.'; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="blog section-padding bg-green">
        <div class="container">
            <div class="row">
                <div class="col-md-5 mb-30">
                    <div class="section-subtitle white"><?php echo e($sections['blog']->heading ?? 'Latest News'); ?></div>
                    <div class="section-title white"><?php echo $sections['blog']->content ?? 'Wedding <span class="white">Blog</span>'; ?></div>
                </div>
                <div class="col-md-7 mb-30">
                    <?php if(isset($sections['blog']->meta['description'])): ?>
                        <p class="white"><?php echo $sections['blog']->meta['description']; ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <div class="row">
...
<?php /**PATH C:\xampp\htdocs\amaanta\resources\views\pages\home.blade.php ENDPATH**/ ?>