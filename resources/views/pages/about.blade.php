...
<head>
    ...
    <title>{{ $aboutPage->title ?? 'About Us' }} - {{ $settings['website_name'] ?? 'Amaanta Farms' }}</title>
...
<!-- Navbar -->
                ...
                <div class="col-md-5 slider-text js-fullheight">
                    <div class="slider-text-inner">
                        <div class="desc text-start">
                            <h4>{{ $sections['about_intro']->meta['subheading'] ?? 'Amaanta' }}</h4>
                            <h1>{{ $sections['about_intro']->heading ?? 'Where Nature Meets Elegance' }}</h1>
                            <p>{!! $sections['about_intro']->content ?? 'A world-class farm in Delhi offering serene <span>natural beauty</span> for unforgettable celebrations.' !!}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp">
                    <div class="section-subtitle">{{ $sections['main_content']->meta['subtitle'] ?? 'About Us' }}</div>
                    <div class="section-title">{{ $sections['main_content']->heading ?? 'Amaanta' }} <span>{{ $sections['main_content']->meta['highlight'] ?? 'Farms' }}</span></div>
                    <p>{!! $sections['main_content']->content ?? '' !!}</p>
                    <ul class="list-unstyled about-list mb-30">
                        <li>
                            <div class="about-list-icon"> <span class="ti-check"></span> </div>
                            <div class="about-list-text">
                                <p>{{ $sections['main_content']->meta['bullet1'] ?? '8 Years of Experience' }}</p>
                            </div>
                        </li>
                        <li>
                            <div class="about-list-icon"> <span class="ti-check"></span> </div>
                            <div class="about-list-text">
                                <p>{{ $sections['main_content']->meta['bullet2'] ?? '250+ Wedding Planner' }}</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="col-md-5 offset-md-1 animate-box" data-animate-effect="fadeInUp">
                    <div class="img-exp">
                        <div class="about-img">
                            <div class="img"> <img src="{{ asset($sections['main_content']->meta['image'] ?? 'assets/img/about.jfif') }}" class="img-fluid" alt=""> </div>
                        </div>
                        <div id="circle">
    ...
    <section class="testimonials">
        <div class="background bg-img bg-fixed section-padding pb-0" data-background="{{ asset('assets/img/slider/cocktails-banner-4.png') }}" data-overlay-dark="5">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2 text-center">
                        <div class="testimonials-box">
                            <div class="owl-carousel owl-theme">
                                @if(isset($sections['testimonials']) && $sections['testimonials']->content)
                                    @foreach(json_decode($sections['testimonials']->content, true) ?? [] as $testimonial)
                                        <div class="item"> 
                                            <span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30">
                    <div class="section-subtitle white">{{ $sections['faq']->heading ?? 'F.A.Qs' }}</div>
                    <div class="section-title white">Amaanta<span class="white">{{ $sections['faq']->meta['subtitle'] ?? 'Questions' }}</span></div>
                    <p class="white"> {!! $sections['faq']->content ?? '' !!}</p>
                </div>
                <div class="col-md-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 p-0">
                    <div class="img left"> <img src="{{ asset('assets/img/signup.jfif') }}" alt=""> </div>
                </div>
