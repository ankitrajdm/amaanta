...
<head>
    ...
    <title>{{ $servicesPage->title ?? 'Services' }} - {{ $settings['website_name'] ?? 'Amaanta Farms' }}</title>
...
<!-- Navbar -->
    ...
    <!-- Header Banner -->
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="3" data-background="{{ asset('assets/img/ab-02.png') }}">
        <div class="container">
            <div class="row">
                <div class="col-md-5 slider-text js-fullheight">
                    <div class="slider-text-inner">
                        <div class="desc text-start">
                            <h4>{{ $sections['hero']->meta['subtitle'] ?? 'Amaanta' }}</h4>
                            <h1>{{ $sections['hero']->heading ?? 'Our Services' }}</h1>
                            <p>{!! $sections['hero']->content ?? 'Explore our comprehensive range of professional services for unforgettable celebrations.' !!}</p>
                        </div>
                    </div>
                </div>
            </div>
