...
<head>
    ...
    <title>{{ $contactPage->title ?? 'Contact Us' }} - {{ $settings['website_name'] ?? 'Amaanta Farms' }}</title>
...
<section class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="3" data-background="{{ $sections['hero']->meta['background'] ?? '/assets/img/ab-01.png' }}">
    <div class="container">
        <div class="row">
            <div class="col-md-5 slider-text js-fullheight">
                <div class="slider-text-inner">
                    <div class="desc">
                        <h4>{!! $sections['hero']->meta['subtitle'] ?? 'Get in touch' !!}</h4>
                        <h1>{!! $sections['hero']->heading ?? 'Contact Information' !!}</h1>
                        <p>{!! $sections['hero']->content ?? 'Fill out the form below I’ll get back to you within 24 hours to book a discovery call and start chatting about all the exciting possibilities.' !!}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mb-90">
            <div class="col-md-5 mb-60">
                <h3>{!! $sections['contact_information']->heading ?? 'Contact Information' !!}</h3>
                @if($settings['contact_no'] ?? null)
                ...
                <div class="contact-info mb-30">
                    ...
                    <div class="text">
                        <p>Address</p> {!! nl2br(e($settings['address'])) !!}
                    </div>
                </div>
                @endif
            </div>
            <div class="col-md-6 mb-30 offset-md-1">
                <h3>{!! $sections['book_event_form']->heading ?? 'Book your event' !!}</h3>
                <p>{!! $sections['book_event_form']->content ?? 'Ask me a question, I\'d love to hear more from you.' !!}</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-30">
                ...
                <p class="white">{!! $sections['faq_intro']->content ?? 'Have questions? We have answers.' !!}</p>
            </div>
            <div class="col-md-6">
