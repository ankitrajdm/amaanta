...
<head>
    ...
    <title>{{ $title ?? 'Admin Panel - ' . (data_get($settings, 'website_name', 'Amaanta')) }}</title>
...
<body>
<div class="wp-topbar">
    <div class="brand">{{ data_get($settings, 'website_name', 'Amaanta') }}</div>
...
<div class="admin-container">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        <div class="sidebar-header">
            <h2>{{ data_get($settings, 'website_name', 'Amaanta') }}</h2>
            <p>Admin Panel</p>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.pages.index') }}" class="@if(Route::currentRouteName() === 'admin.pages.index' || Route::currentRouteName() === 'admin.pages.edit') active @endif">
                            <i class="fas fa-file"></i> Pages
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.posts.index') }}" class="@if(Route::currentRouteName() === 'admin.posts.index' || Route::currentRouteName() === 'admin.posts.store') active @endif">
            ...
            <!-- Media & Gallery -->
            <li>
                <a href="{{ route('admin.gallery.index') }}" class="@if(Route::currentRouteName() === 'admin.gallery.index' || Route::currentRouteName() === 'admin.gallery.store') active @endif">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.testimonials.index') }}" class="@if(Route::currentRouteName() === 'admin.testimonials.index' || Route::currentRouteName() === 'admin.testimonials.store') active @endif">
            ...
            <!-- Navigation -->
            <li>
                <a href="{{ route('admin.menus.index') }}" class="@if(Route::currentRouteName() === 'admin.menus.index') active @endif">
