    ...
    <div class="card-body">
        <form action="{{ isset($contactForm) ? route('admin.contact-forms.update', $contactForm) : route('admin.contact-forms.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('event_date') is-invalid @enderror" id="event_date" name="event_date" value="{{ old('event_date', $contactForm->event_date ?? '') }}">
                @error('event_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control @error('responded_at') is-invalid @enderror" id="responded_at" name="responded_at" value="{{ old('responded_at', $contactForm->responded_at ?? '') }}">
                @error('responded_at')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
