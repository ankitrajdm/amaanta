...
@section('title', 'Add Guest Feedback')
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.guest-feedbacks.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="heard_about_us" id="heard_{{ str_replace(' ', '_', $option) }}" value="{{ $option }}" {{ old('heard_about_us') == $option ? 'checked' : '' }} required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="reservation_method" id="reservation_{{ str_replace(' ', '_', $option) }}" value="{{ $option }}" {{ old('reservation_method') == $option ? 'checked' : '' }} required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="visit_purpose" id="purpose_{{ $option }}" value="{{ $option }}" {{ old('visit_purpose') == $option ? 'checked' : '' }} required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('service_quality') is-invalid @enderror" name="service_quality" required>
                                    ...
                                    <option value="{{ $option }}" {{ old('service_quality') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('cleanliness') is-invalid @enderror" name="cleanliness" required>
                                    <option value="">Select Rating</option>
                                    @foreach($ratingOptions as $option)
                                    <option value="{{ $option }}" {{ old('cleanliness') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                    @endforeach
                                </select>
                                @error('cleanliness')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('staff_rating') is-invalid @enderror" name="staff_rating" required>
                                    <option value="">Select Rating</option>
                                    @foreach($ratingOptions as $option)
                                    <option value="{{ $option }}" {{ old('staff_rating') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                    @endforeach
                                </select>
                                @error('staff_rating')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <textarea class="form-control @error('additional_feedback') is-invalid @enderror" name="additional_feedback" rows="4" placeholder="Any additional comments or suggestions...">{{ old('additional_feedback') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="agree_to_submit" value="1" id="agree_to_submit" {{ old('agree_to_submit') ? 'checked' : '' }}>
